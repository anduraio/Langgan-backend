...
router.post('/new', verifyToken, property.create_post);

router.get('/', verifyToken, property.property_list);

router.delete('/:id', verifyToken, property.property_delete);

router.put('/:id', verifyToken, property.property_update);
